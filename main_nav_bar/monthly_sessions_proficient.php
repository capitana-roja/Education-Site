...
<html>
	<head>
		...
		<meta name=”description” content=”This page allows REDCap users to review proficient monthly sessions”>
		<title>Monthly Sessions: Proficient</title>
	</head>
	<body>
		<!--Navigation bars-->
		<div>
		...
		<br>
		<!--Title-->
		<h1 class="title_no_pdf">Monthly Sessions: Proficient</h1>
		<!--Content-->
