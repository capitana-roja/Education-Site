...
<html>
	<head>
		...
		<meta name=”description” content=”This page allows REDCap users to review beginner monthly sessions”>
		<title>Monthly Sessions: Beginner</title>
	</head>
	<body>
		<!--Navigation bars-->
		<div>
		...
		<br>
		<!--Title-->
		<h1 class="title_no_pdf">Monthly Sessions: Beginner</h1>
		<!--Content-->
