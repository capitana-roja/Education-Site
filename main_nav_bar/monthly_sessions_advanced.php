...
<html>
	<head>
		...
		<meta name=”description” content=”This page allows REDCap users to review advanced monthly sessions”>
		<title>Monthly Sessions: Advanced</title>
	</head>
	<body>
		<!--Navigation bars-->
		<div>
		...
		<br>
		<!--Title-->
		<h1 class="title_no_pdf">Monthly Sessions: Advanced</h1>
		<!--Content-->
